...
void AVRDragon_ver3::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(ControlFire, ETriggerEvent::Triggered, this, &AVRDragon_ver3::GoFire);
	}
}

// 火球コントロール
void AVRDragon_ver3::GoFire(const FInputActionValue& Value) {
